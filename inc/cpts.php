...
function cptui_register_my_taxes_order_type() {
	...
	$args = [
		...
		"show_in_nav_menus" => true,
		"query_var" => true,
		"rewrite" => [ 'slug' => 'order_type', 'with_front' => true, ],
		"show_admin_column" => true,
		"show_in_rest" => true,
		"show_tagcloud" => false,
		"rest_base" => "order_type",
		"rest_controller_class" => "WP_REST_Terms_Controller",
		"rest_namespace" => "wp/v2",
		"show_in_quick_edit" => true,
		"sort" => true,
	...
	register_taxonomy( "order_type", [ "orders" ], $args );
}
add_action( 'init', 'cptui_register_my_taxes_order_type' );
