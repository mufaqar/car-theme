...
<head>
    ...
    <!-- slickSlider  -->
    <link href="<?php bloginfo('template_directory'); ?>/assets/slick/slick.css" rel="stylesheet" />
    <link href="<?php bloginfo('template_directory'); ?>/assets/slick/slick-theme.css" rel="stylesheet" />
